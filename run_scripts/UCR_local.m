...
%parfor number_of_coefficients=20:3:50
    ...
    [gmlvq_mean,roc_val,lcurves_mean,lcurves_std,param_set] = run_validation(coefficients,label,50, 1, 10, 7, etam, etap);
    ...
    'UCR_local', 'etam', num2str(param_set.etam),'etap', num2str(param_set.etap));
