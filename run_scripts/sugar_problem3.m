...
%relable to problem
[newData, newLabels] = reformulateDataset(spectra, labels, 3);
etam = 2;
etap = 1;
...
%for number_of_coefficients=20:5:50
    %while(etam>(3/1000));
        ...
        [gmlvq_mean,roc_val,lcurves_mean,lcurves_std,param_set] = run_validation(coefficients,newLabels,50, 10, 10, [1,2],etam, etap);
        ...
        'problem3local', 'etam', num2str(param_set.etam),'etap', num2str(param_set.etap));
