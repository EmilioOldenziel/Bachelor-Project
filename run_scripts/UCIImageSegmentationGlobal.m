...
dataset_filename = 'segmentation.csv';
...
[gmlvq_mean,roc_val,lcurves_mean,lcurves_std,param_set] = run_validation(data,labels,50, 10, 10);

%save the figures in the results folder
dataset_name = strrep(dataset_filename,'.csv','');
dir_name = strcat(dataset_name, 'UCI_image_seg_global', 'etam', num2str(param_set.etam),'etap', num2str(param_set.etap));
